...
AVAILABLE TOOLS:
- "compute": Use for normal instructions, reasoning, or general tasks.
...
{{
  ...
  "steps": [
    {{
      ...
      "tool_required": "web_search|code_execution|rag_retrieval|chat|compute",
